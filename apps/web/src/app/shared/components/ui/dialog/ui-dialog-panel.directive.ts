...
@Directive({
  ...
  host: {
    class:
      'fixed left-1/2 top-1/2 z-50 w-[min(36rem,calc(100%-2rem))] -translate-x-1/2 -translate-y-1/2 rounded-lg border border-surface-200 bg-white p-6 shadow-xl focus-visible:outline-none',
